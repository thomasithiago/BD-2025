...
-- UPTADE, ATUALIZANDO DADOS DE COLUNA EM TABELAS
UPDATE PRODUTO 
SET VL_PRODUTO= 45, DESC_PRODUTO = ATUALIZADO = 'Atualizado',
UN_MED= 'CX'
WHERE COD_PRODUTO = 3;
...
-- Neste caso uma exeção será lançada, violação da constraint
-- QUE AMARRA O PRODUTO AO ITEM DA NOTA FISCAL 
-- NÃO É POSSIVEL EXCLUIR UMA PK QUE TEM DEPENDENCIAS EM FKs
